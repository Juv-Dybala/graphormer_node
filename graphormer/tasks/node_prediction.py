...
@dataclass
class NodePredictionConfig(FairseqDataclass):
...
@dataclass
class NodePredictionWithFlagConfig(NodePredictionConfig):
    flag_m: int = field(
        default=3,
        metadata={
...
@register_task("node_prediction_with_flag", dataclass=NodePredictionWithFlagConfig)
